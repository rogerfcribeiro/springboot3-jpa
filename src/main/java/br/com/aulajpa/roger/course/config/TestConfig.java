package br.com.aulajpa.roger.course.config;
...
import br.com.aulajpa.roger.course.entities.Payment;
import br.com.aulajpa.roger.course.entities.Product;
import br.com.aulajpa.roger.course.entities.User;
import br.com.aulajpa.roger.course.entities.enums.OrderStatus;
import br.com.aulajpa.roger.course.repositories.CategoryRepository;
import br.com.aulajpa.roger.course.repositories.OrderItemRepository;
import br.com.aulajpa.roger.course.repositories.OrderRepository;
import br.com.aulajpa.roger.course.repositories.ProductRepository;
...
public class TestConfig implements CommandLineRunner {
	...
	@Autowired
	private OrderRepository orderReposiitory;
	...
	public void run(String... args) throws Exception {
		...
		orderReposiitory.saveAll(Arrays.asList(o1, o2, o3));
